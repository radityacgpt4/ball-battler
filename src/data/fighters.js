...
export const FIGHTER_TYPES = {
    SWORD_MASTER: {
        name: "Sword Master",
        color: "#ff6b6b",
        hp: 100, mass: 1.0, speed: 5, rotationSpeed: 0.15,
        skills: {
            atk: { name: "Melee Slash", desc: "Fast melee strikes with a high proc rate.", type: "MELEE_PASSIVE", range: 50, damage: 10, procRate: 3, isPassive: true },
            def: { name: "Parry", desc: "17% chance to block and negate incoming damage.", type: "PARRY_PASSIVE", chance: 0.2, isPassive: true },
            ult: { name: "Dash Assault", desc: "A powerful lunge that deals heavy damage.", type: "DASH_ASSAULT", cooldown: 120, damage: 7, isPassive: false }
        }
    },
    THUNDER_MAGE: {
        name: "Thundermage",
        ...
        skills: {
            atk: { name: "Lightning Bolt", desc: "Chain lightning that bounces between enemies.", type: "RAYCAST", cooldown: 90, range: 800, damage: 18, bounces: 3, isPassive: false },
            def: { name: "Static Field", desc: "Deals damage to nearby enemies passively.", type: "STATIC_PASSIVE", isPassive: true },
            ult: { name: "Double Zap", desc: "Fires two lightning bolts simultaneously.", type: "DOUBLE_ZAP", cooldown: 150, isPassive: false }
        }
    },
    SOLDIER: {
        name: "Rifleman",
        ...
        skills: {
            atk: { name: "Burst Fire", desc: "Fires a rapid 10-shot burst of bullets.", type: "BURST_FIRE", cooldown: 90, count: 10, damage: 3, isPassive: false },
            ...
            ult: { name: "Frag Grenade", desc: "Throws a grenade dealing massive AOE damage.", type: "GRENADE", cooldown: 60, damage: 15, isPassive: false }
        }
    },
    SHIELDBEARER: {
        name: "Shieldbearer",
        ...
        skills: {
            ...
            def: { name: "Greatshield", desc: "Blocks all projectiles from a wide front arc.", type: "SHIELD_DEFLECT", arcAngle: Math.PI * 0.7, isPassive: true },
    ...
    NINJA: {
        ...
        skills: {
            atk: { name: "Flying Raijin", desc: "Throws marked kunai and teleports to them.", type: "KUNAI_MARK", cooldown: 120, count: 2, damage: 8, delay: 90, zapDuration: 60, isPassive: false },
    ...
    CYBORG: {
        ...
        skills: {
            ...
            ult: { name: "Missile Swarm", desc: "Launches a volley of homing missiles.", type: "MISSILE_BARRAGE", cooldown: 120, damage: 7, isPassive: false }
        }
    },
    SNIPER: {
        name: "Sniper",
        ...
        skills: {
            ...
            ult: { name: "Steady Aim", desc: "Passively increases projectile speed and ability to bypass DEF ability.", type: "SNIPER_MODE", cooldown: 300, isPassive: true }
        }
    },
    AXEMAN: {
        name: "Axeman",
        ...
        skills: {
            atk: { name: "Heavy Swing", desc: "Wields a giant axe applying Bleeding status on 2 consecutive hits.", type: "AXE_SWING", isPassive: true },
            def: { name: "Berserker Rage", desc: "Boost MS and AS every 10% HP missing", type: "BERSERKER_RAGE", isPassive: true },
    ...
    BALLISTA: {
        name: "Ballista",
        color: "#8B4513",
        hp: 100, mass: 1.6, speed: 3.6, rotationSpeed: 0.1,
        skills: {
            ...
            ult: { name: "Siege Mode", desc: "Fires triple faster bolts.", type: "SIEGE_MODE", cooldown: 90, damage: 15, isPassive: false }
        }
    },
    DIVINE_GENERAL: {
        name: "Divine General",
